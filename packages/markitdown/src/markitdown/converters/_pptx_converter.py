...
class PptxConverter(DocumentConverter):
    ...
    def _sort_shapes_smart(self, shapes, container_width):
        ...
        for s in shapes:
            try:
                if s.top is not None and s.left is not None and s.width is not None:
        ...
        for s in valid_shapes:
            try:
                if s.width > container_width * 0.65:
                    spanning_shapes.append(s)
                else:
        ...
        **kwargs: Any,  # Options to pass to the converter
        ...
        for slide in presentation.slides:
            ...
            def get_shape_content(shape, **kwargs):
                ...
                if shape.shape_type == pptx.enum.shapes.MSO_SHAPE_TYPE.GROUP:
                    try:
                        ...
                        group_width = None
                    sorted_shapes = self._sort_shapes_smart(shape.shapes, group_width)
            ...
            try:
                ...
                pass
            sorted_shapes = self._sort_shapes_smart(slide.shapes, slide_width)
