...
.venv\Scripts\pyinstaller --noconfirm --onedir --windowed --name "MarkItDownStudio" --icon "icon.ico" --add-data "templates;templates" --add-data "packages;packages" --add-data ".venv/Lib/site-packages/magika/models;magika/models" --add-data ".venv/Lib/site-packages/magika/config;magika/config" desktop.py
